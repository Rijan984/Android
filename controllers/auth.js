...
exports.register = asyncHandler(async (req, res, next) => {
  const { fname,lname,username,email,address,phone,password } = req.body;
...
exports.job = asyncHandler(async (req, res, next) => {
  const { jobs,location,experience,description,position } = req.body;
